package com.example.ksjensen.masterdetailtest;
...
import com.example.ksjensen.masterdetailtest.dummy.DummyContent;
...
public class ParameterDetailFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments().containsKey(ARG_ITEM_ID)) {
            ...
            String test2 = test.getString(ARG_ITEM_ID);
            Map<String,DummyContent.DummyItem> test3 = DummyContent.ITEM_MAP;
            DummyContent.DummyItem test4 = test3.get(test2);
